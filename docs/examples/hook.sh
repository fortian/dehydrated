...
#   Should be served by your web server as
#   /.well-known/acme-challenge/${TOKEN_FILENAME}.
# - TOKEN_VALUE
#   The token value that needs to be served for validation.  For DNS validation,
#   this is what you want to put in the _acme-challenge TXT RR.  For HTTP
#   validation, it is the value that is expected be found in the $TOKEN_FILENAME
#   file.
...
# clean_challenge is called after attempting to validate each domain, whether or
# not validation was successful.  Here you can delete files or DNS records that
...
# deploy_cert is called once for each certificate that has been produced.  You
# might use this to copy your new certificates to service-specific locations and
# reload the service.
...
# code that does not start with '2'.  This might be useful to alert admins about
...
# external tools.  The output should be just the cerificate signing request
# formatted as PEM.
